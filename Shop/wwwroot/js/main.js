        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (totalPriceSales() > 0) {
                    Total = "$" + numeral(totalPriceSales()).format('0,000') + "<small>₫</small>" + " - " + "<del style='color: #888'>" + numeral(totalPrices()).format('0,000') + " <small>₫</small>" + "</del>"
                } else {
