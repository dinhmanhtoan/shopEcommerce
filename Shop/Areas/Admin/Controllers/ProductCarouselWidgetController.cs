...
public class ProductCarouselWidgetController : Controller
{
    private readonly IRepository<WidgetInstance> _widgetInstanceRepository;
    public ProductCarouselWidgetController(IRepository<WidgetInstance> widgetInstanceRepository)
    {
    ...
    public IActionResult Post([FromBody] ProductWidgetForm model)
    {
        if (ModelState.IsValid)
        {
            ...
            {
                Name = model.Name,
                WidgetId = "ProductCarouselWidget",
