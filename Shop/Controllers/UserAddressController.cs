...
public class UserAddressController : Controller
{
    ...
    public UserAddressController(IWorkContext workContext,
    ...
    public async Task<IActionResult> List()
    {
        ...
        var model = _userAddressRepository.Query()
    ...
    {
        var country =  _countryRepository.Query().Include(x => x.StatesOrProvinces).FirstOrDefault(x => x.Id == countryId);
        if (country == null)
        {
            return NotFound();
        }
