...
public class ShipmentService : IShipmentService
{
    ...
    public ShipmentService(IRepository<Stock> stockRepository, IRepository<Shipment> shipmentRepository,
        IRepository<ShipmentItem> shipmentItemRepository , IRepository<OrderItem> orderItemRepository)
    {
    ...
    {
        var orderedItems = await _orderItemRepository.Query().Where(x => x.Order.Id == orderId)
        ...
        var shippedItems = await _shipmentItemRepository.Query().Where(x => x.Shipment.OrderId == orderId).ToListAsync();
